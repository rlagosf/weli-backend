...
import academia_tipo_pago from "./routers/academia_tipo_pago";
import tarifas_academia from "./routers/tarifas_academia";
...
export async function registerRoutes(app: FastifyInstance) {
  ...
  app.register(academia_tipo_pago, { prefix: `${API_BASE}/academia-tipo-pago` });
  app.register(tarifas_academia, { prefix: `${API_BASE}/tarifas-academia` });
} 
